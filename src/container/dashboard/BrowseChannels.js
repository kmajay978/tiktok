        ...
        <SideMenu/>
          <section className="browse_categories_sec">
            <div className="container">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br2.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br3.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>Vevo</a> <span className="verify_ic"><i className="icon-tick" /></span></h3>
                        <span>12 Videos</span>
                      </div>
                    </div>{/*br-channel end*/}
                  </div>
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br4.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>Official PSY</a> <span className="verify_ic"><i className="icon-tick" /></span></h3>
                        <span>48 Videos</span>
                      </div>
                    </div>{/*br-channel end*/}
                  </div>
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br5.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br6.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br7.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>BattleState</a></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br8.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>BlackPink</a></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br9.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>Vevo</a> <span className="verify_ic"><i className="icon-tick" /></span></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br10.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>Official PSY</a> <span className="verify_ic"><i className="icon-tick" /></span></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br11.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>People</a></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br12.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>SmTownSmTown</a></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br13.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>BattleState</a></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br14.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>BlackPink</a></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br15.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>Vevo</a> <span className="verify_ic"><i className="icon-tick" /></span></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br16.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>Official PSY</a> <span className="verify_ic"><i className="icon-tick" /></span></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br17.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>People</a></h3>
                  ...
                  <div className="col-lg-2 col-md-4 col-sm-4 col-6 full_wdth">
                    <div className="br-channel">
                      <div className="br-channel-img">
                        <a href="#" title>
                          <img src="/assets/images/resources/br18.jpg" alt="" />
                        </a>
                      </div>
                      <div className="br-info">
                        <h3><a href="#" title>SmTownSmTown</a></h3>
              ...
              <div className="browse_cat_lists">
